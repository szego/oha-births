...
```{r eval=FALSE}
saveRDS(fc20, "../output/fmod_2020.rds")
```
...
After some testing, this code appears to only work for the 2020 data. Indeed, the reason it won't work for 2019 does seem to be the way that I used the `space` column.
